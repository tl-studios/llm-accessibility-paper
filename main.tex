...
Addressing these gaps motivates the system based on the softwares currently used by the majority of people. Blind and Vision Loss (BLV) users. Using a methodology that consists in a combination of efforts to create a more useful and adaptative tool that can address more issues when navigating web.
