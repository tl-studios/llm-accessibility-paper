...
\begin{table}
    \centering
    \begin{tabular}{cccc}
        Website & Short Description & Category  & Monthly Access \\
...
All websites were accessed 5 times, collecting the following data: 
 Html Size
 Html Size after cleanup 
 JSON Chars Size
 Number of Images
 Number of Images that don't have any alt tag
 Number of images which alt tag char count is more than 240.
 Number of possible actions.
 WCAG violations.
 Time to LLM provide a summary
 Average time to process image
 Number of times that the main task was completed
